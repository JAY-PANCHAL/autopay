...
class SignupDealerScreen extends StatefulWidget {

  SignupDealerScreen({super.key});

  @override
  State<SignupDealerScreen> createState() => _SignupDealerScreenState();
}

class _SignupDealerScreenState extends State<SignupDealerScreen> {
  final controller = Get.put(SignupDealerController());
